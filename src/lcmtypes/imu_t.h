...
struct _imu_t
{
    ...
    float      accel[3];
    float      accel_covariance[3][3];
    float      orientation[4];
    /// quaternion
    float      orientation_covariance[4][4];
};
 ...
 */
typedef struct _imu_t_subscription_t imu_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * imu_t is received.
 */
typedef void(*imu_t_handler_t)(
    const lcm_recv_buf_t *rbuf, const char *channel,
    const imu_t *msg, void *userdata);

/**
 * Publish a message of type imu_t using LCM.
 *
 ...
 */
int imu_t_publish(lcm_t *lcm, const char *channel, const imu_t *msg);

/**
 * Subscribe to messages of type imu_t using LCM.
 *
 ...
 */
imu_t_subscription_t* imu_t_subscribe(
    lcm_t *lcm, const char *channel, imu_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by imu_t_subscribe()
 */
 ...
 * @return 0 on success, <0 if an error occured
 */
int imu_t_subscription_set_queue_capacity(
    imu_t_subscription_t* subs, int num_messages);
...
int __imu_t_encode_array(
    void *buf, int offset, int maxlen, const imu_t *p, int elements);
int __imu_t_decode_array(
    const void *buf, int offset, int maxlen, imu_t *p, int elements);
